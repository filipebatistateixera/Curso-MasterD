...
<head>
    ...
    <title>Criaçao de objetos</title>
</head>
<body>
<?php
    class equipa {
    ...
    $obj2->somarVitoria();
    $obj->somarDerrota();
    echo $obj->lerNome().' com '.$obj->lerGanhos().' jogos ganhos e '.$obj->lerPerdidos(). ' perdidos, tem uma qualidade     média de'.$obj->qualidade().'<br/>';
    echo $obj2->lerNome().' com '.$obj2->lerGanhos().' jogos ganhos e '.$obj2->lerPerdidos(). ' perdidos, tem uma qualidade média de'.$obj2->qualidade().'<br/>';
?>
</body>
</html>