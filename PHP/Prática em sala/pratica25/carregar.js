...
function carregarSelect2(valor) {
    ...
    if (valor == 0) {
        ...
        document.getElementById("foto").style.display = "nome";
...
function inicio() {
    document.getElementById("watch").style.display = "nome";
    document.getElementById("reset").style.display = "nome";
    document.getElementById("foto").style.display = "nome";
}

function selecionadoSelect2(value) {
...
function sauron(value) {
    ...
    document.getElementById("watch").innerHTML = "O infiltrado foi capturado!";
